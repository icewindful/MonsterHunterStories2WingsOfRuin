...
import dataB from '../../../dataMonsterInfoBossInfo.json';
import '../../../resources/css/MonsterInfo/BossMonsterInfo.css'
...
const MosterPart = ({Partcount, Slash, Blunt, Pierce, SDP, BDP, PDP}) => {
    ...
    case 0:
      return(
        <tr className="MonsterInfoBox">
          <th className="MonsterInfoBoxPartWeakness"><PartLoadIcon part={Partcount}/><br ></br></th>
          <th className="MonsterInfoBoxPartWeakness"><WeaknessSlashLoadIcon status={Slash}/><br></br>{SDP}%</th>
          <th className="MonsterInfoBoxPartWeakness"><WeaknessBluntLoadIcon status={Blunt}/><br></br>{BDP}%</th>
          <th className="MonsterInfoBoxPartWeakness"><WeaknessPierceLoadIcon status={Pierce}/><br></br>{PDP}%</th>
        </tr>
      )
...
const PartLoadIcon = ({part}) =>{
    switch (part) {
      ...
      case 1:
          return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part01.png`} alt="Part01"/></div>) 
      case 2:
          return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part02.png`} alt="Part02"/></div>) 
      case 3:
          return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part03.png`} alt="Part03"/></div>) 
      case 4:
          return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part04.png`} alt="Part04"/></div>) 
      case 5:
          return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part05.png`} alt="Part05"/></div>) 
      case 6:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part06.png`} alt="Part06"/></div>) 
      case 7:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part07.png`} alt="Part07"/></div>) 
      case 8:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part08.png`} alt="Part08"/></div>) 
      case 20:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part20.png`} alt="Part20"/></div>) 
      case 21:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part21.png`} alt="Part21"/></div>) 
      case 22:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part22.png`} alt="Part22"/></div>) 
      case 23:
         return(<div className="BossPartBox"><img className="InfoImg" width="30px" src={`/monsterPart/Part23.png`} alt="Part23"/></div>) 
...
export const BossMonsterInfo = () => {

  return(
    <div className="InfoText">
    <tbody>
      {dataB.Boss.map(_item => {
...
export default BossMonsterInfo;
